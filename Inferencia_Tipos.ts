...
let numero; // Si situamos el cursor sobre el tipo de dato podremos ver que es de tipo any
...
let nombre="Juan"; // Si situamos el cursor sobre el tipo de dato podremos ver que es de tipo string
...
var edad: number=23; // Si situamos el cursor sobre el tipo de dato podremos ver que es de tipo number
