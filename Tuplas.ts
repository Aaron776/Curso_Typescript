...
let jugadores: [string, number, boolean] = ["Messi", 10, true]; // aqui especificamos el orden de los datos primero un dato string, luego un dato number y por ultimo un elemento booleano
